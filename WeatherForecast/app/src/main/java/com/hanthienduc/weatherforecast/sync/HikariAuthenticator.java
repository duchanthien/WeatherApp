...
/**
 * Manages "Authentication" to Hikari's backend service.  The SyncAdapter framework
 ...
 */
public class HikariAuthenticator extends AbstractAccountAuthenticator {

    public HikariAuthenticator(Context context) {
        super(context);
    }
